...
/**
 * A batch iterator used to navigate over batched results. Users of this interface must not rely on any thread safety of
 * the underlying implementation.
 */
public interface BatchIterator extends Row {

    /**
     * Moves the iterator to the first row if there is one.
     *
    ...
    /**
     * Advances the iterator to the next row if there is one. If there are no more rows, the iterator is moved after the last row.
     *
