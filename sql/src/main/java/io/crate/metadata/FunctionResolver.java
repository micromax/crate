 ...
 * resolver if static registration by {@link FunctionIdent} is not possible or lead to a high number of permutations.
 */
public interface FunctionResolver {
     ...
     * be used as argument for {@link #getForTypes} got get the actual implementation. If not match is found null is
     * returned.
     *
