...
public class BatchIteratorCollector implements CrateCollector {
    ...
    private final BatchConsumerToRowReceiver consumerToRowReceiver;

    public BatchIteratorCollector(BatchIterator batchIterator, RowReceiver rowReceiver) {
        this.batchIterator = batchIterator;
        this.consumerToRowReceiver = new BatchConsumerToRowReceiver(rowReceiver);
    }

    @Override
    public void doCollect() {
        consumerToRowReceiver.accept(batchIterator, null);
    }
