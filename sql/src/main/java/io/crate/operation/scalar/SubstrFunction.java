...
public class SubstrFunction extends Scalar<BytesRef, Object> {
    ...
    private static class Resolver extends FunctionResolvers.BaseFunctionResolver {

        protected Resolver() {
            super(Signature.size(2, 3).and(
                Signature.of(true, false, Signature.ArgMatcher.STRING, Signature.ArgMatcher.NUMERIC)));
        }
